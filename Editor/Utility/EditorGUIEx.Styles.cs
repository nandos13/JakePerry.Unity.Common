...
namespace JakePerry.Unity
{
    public static partial class EditorGUIEx
    {
        ...
        /// </summary>
        internal static EditorStyles CurrentStyles => (EditorStyles)typeof(EditorStyles).GetField("s_Current", BindingFlags.Static | BindingFlags.NonPublic).GetValue(null);
        ...
        /// </returns>
        internal static GUIStyle GetStyle(string fieldName)
        {
